    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-gray-900 mb-6">Anesthesia Internship Tracker</h1>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Procedure Logging</h3>
            <p className="text-gray-600">
              Track anesthesia procedures with detailed counts, notes, and timestamps for
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-gray-600">
              Multi-level verification process with tutors and supervisors ensuring quality and
              accuracy of logged procedures.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-gray-600">
              Real-time dashboards and progress tracking with detailed analytics and export
              capabilities.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center p-6 border-2 border-blue-200 rounded-xl">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Interns</h3>
              <p className="text-gray-600 mb-4">Log procedures and track personal progress</p>
              <div className="text-sm text-gray-500">
                <p>• Create procedure logs</p>
                <p>• View personal dashboard</p>
            ...
            <div className="text-center p-6 border-2 border-green-200 rounded-xl">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Tutors</h3>
              <p className="text-gray-600 mb-4">Verify and mentor intern progress</p>
              <div className="text-sm text-gray-500">
                <p>• Verify procedure logs</p>
                <p>• Review intern progress</p>
            ...
            <div className="text-center p-6 border-2 border-purple-200 rounded-xl">
              ...
              <p className="text-gray-600 mb-4">Manage system and oversee operations</p>
              <div className="text-sm text-gray-500">
                <p>• Manage rotations & procedures</p>
                <p>• Set requirements & standards</p>
                <p>• Export reports & analytics</p>
              </div>
            </div>
          </div>
        </div>
