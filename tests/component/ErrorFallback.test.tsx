...
describe('ErrorFallback', () => {
  ...
  it('shows error details in development mode', () => {
    ...
    const errorDetails = screen.getByText((content, element) => {
      return element?.tagName.toLowerCase() === 'pre' && content.includes('Test error message');
    });
  ...
  it('displays error icon', () => {
    ...
    const icon = screen.getByText('Something went wrong').parentElement?.querySelector('svg');
