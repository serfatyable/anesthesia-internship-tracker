  ...
  return (
    <div className={cn('space-y-4 sm:space-y-6', className)}>
      ...
      <div className='grid gap-3 sm:gap-4 sm:grid-cols-2 lg:grid-cols-3'>
        <div className='rounded-2xl border border-zinc-200/60 p-4 sm:p-6 bg-blue-50 '>
        ...
        <div className='rounded-2xl border border-zinc-200/60 p-4 sm:p-6 bg-amber-50 '>
          <div className='flex items-center'>
            <div className='flex-shrink-0'>
              <div className='w-6 h-6 sm:w-8 sm:h-8 bg-amber-600 rounded-lg flex items-center justify-center'>
                <svg
                  className='w-4 h-4 sm:w-5 sm:h-5 text-white'
                  fill='none'
                  stroke='currentColor'
        ...
        <div className='rounded-2xl border border-zinc-200/60 p-4 sm:p-6 bg-green-50 '>
          <div className='flex items-center'>
            <div className='flex-shrink-0'>
