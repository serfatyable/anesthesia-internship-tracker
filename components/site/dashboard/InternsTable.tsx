        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-zinc-200 dark:border-zinc-700">
              ...
              <th className="text-center py-3 px-2 font-medium text-zinc-900 dark:text-zinc-100">
                Verified
              </th>
              <th className="text-center py-3 px-2 font-medium text-zinc-900 dark:text-zinc-100">
                Pending
            ...
            {interns.map((intern) => (
              ...
              >
                <td className="py-3 px-2">
                  <div className="font-medium text-zinc-900 dark:text-zinc-100">{intern.name}</div>
                </td>
                <td className="py-3 px-2">
                  <div className="text-sm text-zinc-600 dark:text-zinc-400">{intern.email}</div>
                </td>
