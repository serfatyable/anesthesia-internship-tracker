    ...
    return (
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-6 h-full">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Procedure & Knowledge Favorites</h3>
            <p className="text-sm text-gray-600">No favorites yet</p>
          </div>
        </div>
        <p className="text-sm text-gray-600">
          Start adding procedures and knowledge topics to your favorites by clicking the star icon
          next to items in your rotations.
        </p>
      </div>
    );
  }
      ...
      <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                <div
                  className={cn(
                    ...
                    favorite.itemType === 'PROCEDURE' ? 'bg-blue-500' : 'bg-green-500',
                  )}
                />
                <div>
        ...
        {favorites.length > 3 && (
          <div className="text-center">
            <p className="text-sm text-gray-500">+{favorites.length - 3} more favorites</p>
          </div>
        )}
      </div>
    </div>
